...
//Global variable for pizza image, this was moved here so that this image is only
//loaded once
...
var resizePizzas = function(size) { 
  ...
  function changePizzaSizes(size) {
    ...
    //moved randomPizza variable to outside for loop and change to faster API call
...
//Passing type to determine source, if called during initial load or scrolling
...
//Generates the sliding pizzas when the page loads. - converted to normal function so it
//can be loaded during page load as they are visible above the fold
